...
class qcGUI:
    def __init__(self, master):
        ...
        self.label7 = Label(master, text="Compress Ratio",font="Sans 12")
        self.label7.place(x=0, y=165)
        self.label7.bind("<Enter>", self.l7enter)
        self.label7.bind("<Leave>", self.leave)
        self.sliderb = Scale(master, from_=16, to=2, orient=HORIZONTAL,font="Sans 12")
        ...
        self.cancel_button = Button(master, text="Cancel", font="Sans 12", command=self.end)
    ...
    def new_labela(self, data):
        try:
            if self.label5 != "":
                self.label5.destroy()
            self.label5 = Label(text = data,font="Sans")
    ...
    def new_labelb(self, data):
        try:
            if self.label6 != "":
                self.label6.destroy()
            self.label6 = Label(text = data,font="Sans")
    ...
    def confirmation(self):
        ...
        self.no = Button(self.master2, text = "Cancel", font = "Sans 12", command=self.end)
    ...
    while (myGUI.runStater("pass") == True):    
        for i in range(len(imageNames)):
            ...
            # Compressing the file          
                ...
                print("Image is being accessed, permissions are denied, or filetype is obfuscated.")
                continue
